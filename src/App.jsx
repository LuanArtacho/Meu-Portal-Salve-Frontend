...
export default function App() {
  ...
  const contractAddress = "0x46784E048b131390Cc6a8aA002FC5948736e8d0E";
  ...
  const wave = async () => {
    try {
      ...
      if (ethereum) {
        ...
        */
        const waveTxn = await wavePortalContract.wave("SALVEE, CHEGUEI NA WEB3.0!!", { gasLimit: 300000 });
  ...
  return (
    <div className="mainContainer">
      ...
      <div className="dataContainer">
        ...
        <div className="bio">
        Eu sou o Luan e faço jiu-jitsu, Dahora né? Conecte sua carteira Ethereum e me manda um Salve!
        </div>
